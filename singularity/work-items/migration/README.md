...
Durable reference-driven-build workflow state for branch `migration`.
...
- [context/reference-repositories.json](./context/reference-repositories.json) — immutable read-only source repository pins
